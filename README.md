...
The [Destiny Shard](https://destiny.mystler.eu/) is a sandbox environment that can be used to test new Ages and other changes to the game. You can use GetUru to install and update a copy of Uru for use on the Destiny Shard.
...
6. If you have not [registered an account](https://destiny.mystler.eu/signup) on the Destiny Shard, do so at this time. Avoid using a password longer than 15 characters.
...
8. Login using the account you registered on the Destiny website.
